...
namespace CourseDemo.Areas.Admin.Controllers
{
    public class TrainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Passowrd,Website,CreationDate,Description")] Trainer trainer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Passowrd,Website,CreationDate,Description")] Trainer trainer)
        {
            if (ModelState.IsValid)
            {
