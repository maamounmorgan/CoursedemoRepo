...
namespace CourseDemo.Areas.Admin.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Password,CreationDate,IsActive")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Password,CreationDate,IsActive")] Trainee trainee)
        {
            if (ModelState.IsValid)
            {
